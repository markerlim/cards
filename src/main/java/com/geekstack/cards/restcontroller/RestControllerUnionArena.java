...
public class RestControllerUnionArena {
    ...
    // http//localhost:8080/data/unionarena/{animecode}
    ...
    public ResponseEntity<List<UnionArenaCard>> searchUnionArena(@PathVariable String term) {
        return new ResponseEntity<List<UnionArenaCard>>(cardListService.listofunionarena().searchDatabase(term),
                HttpStatus.OK);
    }

    // http//localhost:8080/data/unionarena/filter/{booster or color or rarity}/{animecode}
